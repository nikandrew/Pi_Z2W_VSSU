...
**Полная, надежная система для записи 1-минутного видео с камеры по команде RS-485.**
...
✅ Асинхронное слушание RS-485 на скорости 2 Мбит/с  
✅ Запись 1-минутного видео в H.264 при команде "start"  
...
UART_BAUDRATE = 2_000_000            # 2 Мбит/с
...
```
2024-01-15 10:23:45,123 - INFO - Система камеры запущена
2024-01-15 10:23:46,234 - INFO - Подключено к /dev/serial0 (2000000 бод)
2024-01-15 10:23:50,567 - INFO - Получена команда: b'start'
2024-01-15 10:23:50,890 - INFO - Запуск записи видео: ./videos/video_20240115_102350.h264
2024-01-15 10:24:51,234 - INFO - Видео записано: ./videos/video_20240115_102350.h264 (45.2 МБ)
2024-01-15 10:24:52,567 - INFO - Разделение видео 45.2 МБ на части по 50 МБ
2024-01-15 10:24:52,890 - INFO - Видео уже меньше 50 МБ, разделение не требуется
2024-01-15 10:24:53,123 - INFO - Отправлено по RS-485: b'recording_complete'
```
...
- Проверьте скорость передатчика (должна быть 2 Мбит/с)
...
- **RAM**: ~80 МБ
- **Размер видео**: ~15-20 МБ за 1 минуту
...
1. **Используйте экранированный кабель** для RS-485 на 2 Мбит/с
