...
**Полная, надежная система для записи 10-минутного видео с камеры по команде RS-485.**
...
✅ Запись 10-минутного видео в H.264 при команде `00 01`  
...
2024-010-15 10:23:46,234 - INFO - Подключено к /dev/serial0 (115200 бод)
